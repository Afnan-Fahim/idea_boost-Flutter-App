...
// ─── Accent color for Shot Ideas ───
const _kShotAccent = Color(0xFF38BDF8); // Sky blue / cinema
...
class _ShotIdeasScreenState extends State<ShotIdeasScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (widget.initialInput != null && widget.initialInput!.isNotEmpty) {
        ...
        final vm = Provider.of<ShotIdeasViewModel>(context, listen: false);
  ...
  void _showFeedback(BuildContext context, String message, {Color? color}) {
    showSnackBarSafe(
      ...
      SnackBar(
        ...
        backgroundColor: color ?? _kShotAccent,
        behavior: SnackBarBehavior.floating,
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: AutoSizeText(
                            isRegeneration
                                ? 'shot_ideas.regenerate_title'.tr()
                                : 'shot_ideas.tone_selection_title'.tr(),
                            style: const TextStyle(
                              color: Colors.white,
                              fontSize: 17,
                              fontWeight: FontWeight.w600,
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 24),
                    child: Text(
                      'shot_ideas.tone_selection_subtitle'.tr(),
                      style: TextStyle(
                        fontSize: 13,
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: vm.availableTones.map((tone) {
                              ...
                              return GestureDetector(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isSelected
                                        ? _kShotAccent.withOpacity(0.15)
                                        : Colors.white.withOpacity(0.05),
                                    borderRadius: BorderRadius.circular(20),
                                    border: Border.all(
                                      color: isSelected
                                          ? _kShotAccent.withOpacity(0.5)
                          ...
                          const SizedBox(height: 12),
                          AutoSizeText(
                            'shot_ideas.tone_selection_min'.tr(),
                            style: TextStyle(
                              fontSize: 12,
                ...
                child: Container(
                  decoration: const BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [Color(0xFF12121A), Color(0xFF0C0C12)],
                    ),
                  ),
                  child: SafeArea(
                    bottom: false,
  ...
  // ======================== TOP BAR ========================
  Widget _buildTopBar(BuildContext context, ShotIdeasViewModel vm) {
    return Padding(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              height: 60,
              decoration: BoxDecoration(
                color: _kShotAccent.withOpacity(0.1),
                shape: BoxShape.circle,
              ),
              child: const Icon(
                Icons.videocam_rounded,
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        _kShotAccent.withOpacity(0.4),
                        _kShotAccent.withOpacity(0.12),
                      ],
                    ),
                    shape: BoxShape.circle,
                  ),
  ...
  // ======================== RESULTS VIEW ========================
  Widget _buildResultsView(BuildContext context, ShotIdeasViewModel vm) {
    return ListView(
          ...
          Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: _kShotAccent.withOpacity(0.08)),
              ),
              child: Text(
                vm.input,
                style: const TextStyle(
                          ...
                          children: vm.lastGeneratedTones.map((tone) {
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(12),
                                border: Border.all(
                                  color: _kShotAccent.withOpacity(0.25),
                                ),
                              ),
                              child: AutoSizeText(
                                vm.getToneLabel(tone),
  ...
  // ======================== INPUT BAR ========================
  Widget _buildInputBar(BuildContext context, ShotIdeasViewModel vm) {
    return SafeArea(
      top: false,
      child: Padding(
  ...
  // ======================== BOTTOM BAR ========================
  Widget _buildBottomBar(BuildContext context, ShotIdeasViewModel vm) {
    return SafeArea(
      top: false,
      child: Container(
        padding: const EdgeInsets.fromLTRB(16, 12, 16, 16),
        decoration: BoxDecoration(
          color: const Color(0xFF101018).withOpacity(0.95),
          border: Border(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Icon(
                  Icons.tune,
                  size: 20,
                  color: _kShotAccent.withOpacity(0.8),
                ),
              ),
            ),
            const SizedBox(width: 10),
...
// ======================== TYPING DOTS ========================
class _ShotTypingDots extends StatefulWidget {
  @override
  State<_ShotTypingDots> createState() => _ShotTypingDotsState();
}

class _ShotTypingDotsState extends State<_ShotTypingDots>
    with SingleTickerProviderStateMixin {
            ...
            return Container(
              ...
              child: Transform.translate(
                ...
                child: Container(
                  ...
                  height: 8,
                  decoration: BoxDecoration(
                    color: _kShotAccent.withOpacity(0.35 + 0.45 * bounce),
                    shape: BoxShape.circle,
                  ),
                ),
              ),
